        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-stretch">
          {plans.map((plan, index) => (
            ...
            >
              {plan.tag && (
                <span
                  className={`absolute -top-3.5 left-1/2 -translate-x-1/2 px-4 py-1.5 rounded-[10px] text-xs font-bold uppercase tracking-wider ${
                    plan.isPopular
              ...
              <div>
                ...
                <div className="border-t border-b border-gray-100 py-6 mb-6 text-center bg-gray-50/50 rounded-[10px]">
                  ...
                  <span className="text-2xl font-black text-blue-950 lg:text-3xl">
                    {plan.price_inr}
                  </span>
                </div>
                ...
                <ul className="space-y-4 mb-8">
                  {plan.features.map((feature, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      <div
                        className={`p-0.5 rounded-[10px] flex-shrink-0 mt-0.5 ${
                          plan.isPopular
                            ? "bg-blue-900 text-white"
