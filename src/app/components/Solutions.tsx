          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {programs.map((program, index) => {
              return (
                <div
                  key={index}
                  className="group flex cursor-pointer flex-col justify-between rounded-[10px] border border-gray-200 bg-white p-6 transition-all duration-300 hover:border-blue-900/30 hover:shadow-xl sm:p-8"
                >
                  <div>
