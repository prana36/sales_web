...
import { Award, Briefcase, GraduationCap, Users, Sparkles, CheckCircle2 } from "lucide-react";
...
export default function Visionary() {
  ...
  return (
    <section id="top_sales_trainer" className="bg-white px-4 py-16 sm:px-6 md:py-24">
      <div className="max-w-7xl mx-auto">
        
        {/* Header */}
        <div className="text-center mb-16">
          <p className="text-sm font-semibold text-blue-900 tracking-wider uppercase mb-2">Training Program Designer</p>
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 relative group">
            ...
            <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between gap-4 rounded-[10px] border border-gray-800 bg-gray-900 p-4 text-white shadow-xl sm:-bottom-6 sm:left-6 sm:right-6 sm:p-6">
              <div>
                <h3 className="font-bold text-xl text-yellow-500">Sanjay Singh</h3>
