  ...
  const journeySteps: JourneyStep[] = [
    {
      tag: "Gap Analysis",
      title: "Gap Analysis",
      text: "We study product performance, territory performance and salespersons performance to understand “Gaps” in process, programs and procedures. Regression Analysis over last 5 years, Projected growth in next 5 years, Gap Analysis report with suggestions.",
      cta: { label: "Schedule Gap Analysis", href: "#contact" },
      points: [
        { icon: BarChart3, label: "Regression Analysis over last 5 years" },
        { icon: TrendingUp, label: "Projected growth in next 5 years" },
        { icon: ClipboardCheck, label: "Gap Analysis report with suggestions", url: "/gap-analysis" },
      ],
    },
    {
      tag: "Process",
      title: "Blueprint for Success",
      text: "Based on Gap Analysis, we propose changes in process, programs, procedures and people. Change Management Program, Go to Market Plan, Strategic direction, Caveats.",
      cta: { label: "Contact Us", href: "#contact" },
      points: [
        { icon: RefreshCw, label: "Change Management Program" },
        { icon: LineChart, label: "Go to Market Plan" },
        { icon: TrendingUp, label: "Strategic direction & Caveats" },
      ],
    },
    {
      tag: "Program",
      title: "Annual Retainership Contract (ARC)",
      text: "An annual contract to implement the Blueprint for Success with guarantee by empowerment, enablement and execution. Daily monitoring, Weekly Review, Monthly MIS, Learning and Development, On the Job Coaching.",
      cta: { label: "Enquire Now", href: "#contact" },
      points: [
        { icon: Activity, label: "Daily monitoring & Weekly Review" },
        { icon: BarChart2, label: "Monthly MIS" },
        { icon: Award, label: "Learning & Development, On the Job Coaching" },
      ],
    },
    {
      tag: "Procedures",
      ...
      cta: { label: "Contact Us", href: "#contact" },
      points: [
        { icon: ClipboardCheck, label: "SOP Documentation" },
        { icon: Award, label: "Compliance Monitoring" },
        { icon: SearchCheck, label: "Process Audit" },
      ],
    },
  ];
