  ...
  return (
    <section className="bg-brand-cream px-4 pb-10 pt-28 sm:px-6 sm:pb-14 sm:pt-32 lg:px-8 lg:pt-36">
      <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[1.1fr_1fr]">
        ...
        <motion.div
          className="relative min-h-[420px] overflow-hidden rounded-[2rem] sm:min-h-[520px] lg:min-h-0"
        ...
        >
          ...
          <motion.div
            className="absolute right-5 top-24 flex items-center gap-2 rounded-full bg-brand-navy px-4 py-2 shadow-lg"
            initial={{ opacity: 0, x: 12 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          <motion.div
            className="absolute bottom-5 left-5 right-5 rounded-2xl bg-white/95 p-4 shadow-xl backdrop-blur-md sm:right-auto sm:w-56"
